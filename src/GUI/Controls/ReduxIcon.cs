...
public static class ReduxIconCatalog
{
	public static IReadOnlyList<ReduxIconChoice> Choices { get; } = new List<ReduxIconChoice>
	{
		...
		new("bird", "Bird / familiar", "Redux.Icon.Bird", true),
		new("skull", "Undead / danger", "Redux.Icon.Skull"),
		new("ghost", "Ghost / spectral", "Redux.Icon.Ghost", true),
		...
		new("boxes", "Item collection / inventory", "Redux.Icon.Boxes", true),
		new("backpack", "Backpack / inventory", "Redux.Icon.Backpack", true),
		new("diamond", "Gem / treasure", "Redux.Icon.Diamond"),
		new("coins", "Currency / treasure", "Redux.Icon.Coins", true),
		new("key", "Key", "Redux.Icon.Key"),
		new("lock", "Locked / restricted", "Redux.Icon.LockKeyhole", true),
		...
		new("trees", "Forest / wilderness", "Redux.Icon.Trees", true),
		new("mountain", "Mountain / terrain", "Redux.Icon.MountainSnow", true),
		new("shell", "Shell / coastal", "Redux.Icon.Shell", true),
		...
		new("route", "Route / progression", "Redux.Icon.Route", true),
		new("footprints", "Footprints / movement", "Redux.Icon.Footprints", true),
		new("land-plot", "Location / territory", "Redux.Icon.LandPlot", true),
		new("tent", "Camp / outdoors", "Redux.Icon.TentTree", true),
		new("ship-wheel", "Nautical / ship", "Redux.Icon.ShipWheel", true),
		new("door-open", "Door / interior", "Redux.Icon.DoorOpen", true),
		new("castle", "Castle / stronghold", "Redux.Icon.Castle", true),
		new("target", "Objectives / targets", "Redux.Icon.Target", true),
		new("flag", "Flag / objective", "Redux.Icon.Flag", true),
		new("dice", "Dice", "Redux.Icon.Dice"),
		new("gameplay", "Game controller", "Redux.Icon.GameController"),
		new("calendar", "Calendar / schedule", "Redux.Icon.CalendarDays", true),
		new("clock", "Time / history", "Redux.Icon.Clock", true),
		...
		new("mask", "Mask / appearance", "Redux.Icon.VenetianMask", true),
		...
		new("mouse-pointer", "Pointer / interaction", "Redux.Icon.MousePointer", true),
		new("sliders", "Controls / adjustments", "Redux.Icon.SlidersHorizontal", true),
		new("languages", "Languages / localization", "Redux.Icon.Languages", true),
		new("accessibility", "Accessibility", "Redux.Icon.Accessibility", true),
		...
		new("notebook", "Notebook / reference", "Redux.Icon.NotebookTabs", true),
		new("blocks", "Libraries / framework", "Redux.Icon.Blocks", true),
		new("layers", "Layers / load order", "Redux.Icon.Layers", true),
		new("database", "Resources / data", "Redux.Icon.Database", true),
		new("puzzle", "Patch / extension", "Redux.Icon.ExtensionPuzzle"),
		new("plug", "Plugin / integration", "Redux.Icon.Plug", true),
		new("workflow", "Workflow / dependency", "Redux.Icon.Workflow", true),
		...
		new("code", "Code / XML", "Redux.Icon.CodeXml", true),
		new("settings", "Settings", "Redux.Icon.Settings"),
		new("search", "Search / discovery", "Redux.Icon.Search", true),
		new("refresh", "Refresh / overhaul", "Redux.Icon.RefreshStroke", true),
		new("download", "Download", "Redux.Icon.Download"),
		new("upload", "Upload / export", "Redux.Icon.CloudUpload", true),
		new("circle-check", "Complete / enabled", "Redux.Icon.CircleCheck", true),
		new("circle-minus", "Disabled / excluded", "Redux.Icon.CircleMinus", true),
