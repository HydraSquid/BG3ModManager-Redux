...
public sealed class AppUpdateWindowViewModelTests
{
	public void AvailableUpdateOffersVerifiedRestart()
	{
		...
		RegressionAssert.Contains(viewModel.UpdateDescription, "0.1.0-alpha.15");
	...
	{
		using var client = ClientReturning(HttpStatusCode.OK, Manifest("0.1.0-alpha.14", "0.1.0.14"));
		var viewModel = CreateViewModel(client);
