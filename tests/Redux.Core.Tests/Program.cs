...
internal static class Program
{
	...
	private static int Main()
	{
		...
		var tests = new (string Name, Action Run)[]
		{
			...
			(nameof(paneSplitters.OverridePaneResizesAndRetainsHeightAcrossCollapse), paneSplitters.OverridePaneResizesAndRetainsHeightAcrossCollapse),
			...
			(nameof(forkTableStriping.ActualModRowsAlternateAcrossBuiltInAndLiveCustomThemes), forkTableStriping.ActualModRowsAlternateAcrossBuiltInAndLiveCustomThemes),
			...
			(nameof(source.NativePublishHandleWinsOverCreatorManifestWithoutAnApiKey), source.NativePublishHandleWinsOverCreatorManifestWithoutAnApiKey),
			...
			(nameof(nxmActivation.ForkAndUpstreamInstancesAndActivationRemainIndependent), nxmActivation.ForkAndUpstreamInstancesAndActivationRemainIndependent),
			...
			(nameof(nxmAssociation.FailedTakeoverRestoresMarkedHandler), nxmAssociation.FailedTakeoverRestoresMarkedHandler),
			(nameof(source.ManualModioAssociationWinsOverBundledNexusMetadata), source.ManualModioAssociationWinsOverBundledNexusMetadata),
			(nameof(source.ManualModioUrlIsNotEligibleForAutomaticCatalogAssociation), source.ManualModioUrlIsNotEligibleForAutomaticCatalogAssociation),
			(nameof(source.ImportedNexusAssociationClearsManualModioCacheBeforeReload), source.ImportedNexusAssociationClearsManualModioCacheBeforeReload),
			(nameof(source.UnknownImportedArchivePreservesManualModioSource), source.UnknownImportedArchivePreservesManualModioSource),
